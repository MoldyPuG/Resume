...
データの中央組織に属するデータエンジニア、アナリティクスエンジニアとして、日々ユーザーが手軽かつ安全に利用できるデータの提供に努めてきました。
一つの事業部の中に属していないため、常に様々なステークホルダーと連携をしながら業務を遂行しています。
また、上記のいくつかの職務経歴に挙げたように、テラバイト規模のデータやユーザーへの影響範囲が大きいデータを扱うことが多いため、常に自分の修正、追加などの作業を行うことによって、どんな影響を及ぼすかを意識しながらデータの生成、改修を行いながら、実装、テストを行っています。 <br>
また、①に記載したProjectで、SQLを利用して多くのステークホルダーと関わりながら、様々なデータを利用し、ビジネスにつながるデータを生成できたことは面白いなと感じており、今後はさらにビジネスサイドに近く貢献することにも興味を持っています。
また、今はまだ勉強中ではありますが、様々な課題に対してそれをどう対処するかというボトムアップのアプローチだけでなく、データモデリングやデータマネジメントの一般的な理論から見て、組織やデータパイプラインにどんな課題が存在するのか俯瞰的に考えられるなデータ人材を目指していきたいと考えています。
